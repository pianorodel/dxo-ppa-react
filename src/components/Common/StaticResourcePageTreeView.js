...
const StaticResourcePageTreeView = ({
  title,
  codeField,
  moduleName,
  listName,
        ...
        <Row>
          <Col lg="3" xl="3">
            <Card style={isMobile ? {} : { minHeight: "74vh" }}>
              <CardBody>{TreeViewComponent}</CardBody>
            </Card>
          </Col>
            ...
            <Card style={isMobile ? {} : { minHeight: "74vh" }}>
              <div className="card-body pt-0">
                <CardHeader>
                  <Row>
                    <Col lg={6}>
                      <h5 className="card-title mb-0">List of {listName}</h5>
                    </Col>
                  </Row>
                </CardHeader>
                <CardBody>
...
export default StaticResourcePageTreeView;
