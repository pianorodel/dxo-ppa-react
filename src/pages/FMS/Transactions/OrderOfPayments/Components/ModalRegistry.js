...
export const ModalRegistry = {
  ...
  update: {
    ...
    getProps: ({ state, handlers }) => ({
      ...
      data: state.trxValue,
      accessRights: [FMS_ACCESS_RIGHTS.FMS_TRANSACTIONS_ORDEROFPAYMENTS_REQUESTOR],
  ...
  logs: {
    ...
    getProps: ({ state, handlers }) => ({
      ...
      title: "Order Of Payment History",
      subTitle: state?.trxValue?.referenceNo || "",
      transactionId: state?.trxValue?.orderOfPaymentId || 0,
      data: state?.trxValue,
