...
export const getAppropriationColumns = (handleActions) => {
  const desktopColumns = [
    ...
    {
      header: "Personnel Services",
      accessorKey: "psAmount",
      enableColumnFilter: false,
      size: 70,
      minSize: 70,
      maxSize: 70,
