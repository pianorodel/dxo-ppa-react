...
import { useApproveCollectionsMutation, useCancelCollectionsMutation, useRejectCollectionsMutation, useReturnCollectionsMutation } from "@/api/Endpoints/FMS/Transactions/Collection/Collections";
...
const ActionModal = ({
  ...
  // Calling Action API
  const [returnAction, { isLoading: isReturning }] = useReturnCollectionsMutation();
  const [approveAction, { isLoading: isApproving }] = useApproveCollectionsMutation();
  const [rejectAction, { isLoading: isRejecting }] = useRejectCollectionsMutation();
  const [cancelAction, { isLoading: isCanceling }] = useCancelCollectionsMutation();
