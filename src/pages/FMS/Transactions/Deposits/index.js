...
import { getDepositColumns } from "./Components/Columns";
...
const VIEWER_RIGHTS = [FMS_ACCESS_RIGHTS.FMS_TRANSACTIONS_DEPOSITS_VIEWER];
const REQUESTOR_RIGHTS = [FMS_ACCESS_RIGHTS.FMS_TRANSACTIONS_DEPOSITS_REQUESTOR];
const REQUESTOR_APPROVER_RIGHTS = [
  FMS_ACCESS_RIGHTS.FMS_TRANSACTIONS_DEPOSITS_REQUESTOR,
  FMS_ACCESS_RIGHTS.FMS_TRANSACTIONS_DEPOSITS_APPROVER,
];
...
const Deposit = () => {
  ...
  const [deleteMutation] = useDeleteDepositsMutation();
  const [exportMutation] = useExportDepositsMutation();
  const [exportListForViewerMutation] = useExportListForViewerDepositsMutation();
  ...
  const resolvedQuery = useMemo(
    () => (isViewerOnly ? useGetListDepositsForViewersQuery : useGetDepositsQuery),
    [isViewerOnly],
  );
