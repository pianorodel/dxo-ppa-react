...
export const getDepositColumns = (handleActions) => {
    ...
    },
{
    ...
    {
      header: "Mode of Deposit",
      accessorKey: "depositMode",
      enableColumnFilter: false,
      cell: ({ row }) => {
        const transaction = row.original;
        return (
          <TextColumn
            text={transaction.depositMode}
            onClick={() => handleActions(transaction.actions.edit || transaction.actions.save ? "update" : "viewDetails", transaction)}
          />
        );
      },
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <AmountColumn
            amount={transaction.totalDepositAmount}
            onClick={() => handleActions(transaction.actions.edit || transaction.actions.save ? "update" : "viewDetails", transaction)}
          />
        );
      },
