...
import { useApproveAllotmentsMutation, useCancelAllotmentsMutation, useRejectAllotmentsMutation, useReturnAllotmentsMutation } from "@/api/Endpoints/FMS/Transactions/Allotment/Allotments";
...
const ActionModal = ({
  ...
  // Calling Action API
  const [returnAction, { isLoading: isReturning }] = useReturnAllotmentsMutation();
  const [approveAction, { isLoading: isApproving }] = useApproveAllotmentsMutation();
  const [rejectAction, { isLoading: isRejecting }] = useRejectAllotmentsMutation();
  const [cancelAction, { isLoading: isCanceling }] = useCancelAllotmentsMutation();
