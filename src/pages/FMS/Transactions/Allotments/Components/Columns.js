...
export const getAllotmentColumns = (handleActions) => {
  const desktopColumns = [
    ...
    {
      header: "Appropriation No.",
      accessorKey: "appropriationNo",
      enableColumnFilter: false,
      size: 140,
      minSize: 140,
      maxSize: 140,
      cell: ({ row }) => {
        ...
        return (
          <ReferenceNoColumn
            text={transaction.appropriationNo}
            onClick={() => handleActions(transaction.actions.edit || transaction.actions.save ? "update" : "viewDetails", transaction)}
          />
        );
      },
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <TextColumn
            text={transaction.financingSourceName}
            onClick={() => handleActions(transaction.actions.edit || transaction.actions.save ? "update" : "viewDetails", transaction)}
          />
        );
      },
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <TextColumn
            text={transaction.authorizationCodeName}
            onClick={() => handleActions(transaction.actions.edit || transaction.actions.save ? "update" : "viewDetails", transaction)}
          />
        );
      },
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <TextColumn
            text={transaction.expenseClassName}
            onClick={() => handleActions(transaction.actions.edit || transaction.actions.save ? "update" : "viewDetails", transaction)}
          />
        );
      },
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <TextColumn
            text={transaction.objectCodeName}
            onClick={() => handleActions(transaction.actions.edit || transaction.actions.save ? "update" : "viewDetails", transaction)}
          />
        );
      },
