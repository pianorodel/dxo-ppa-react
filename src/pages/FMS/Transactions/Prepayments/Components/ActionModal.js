...
import { useApprovePrepaymentsMutation, useCancelPrepaymentsMutation, useRejectPrepaymentsMutation, useReturnPrepaymentsMutation } from "@/api/Endpoints/FMS/Transactions/Prepayment/Prepayments";
...
const ActionModal = ({
  ...
  // Calling Action API
  const [returnAction, { isLoading: isReturning }] = useReturnPrepaymentsMutation();
  const [approveAction, { isLoading: isApproving }] = useApprovePrepaymentsMutation();
  const [rejectAction, { isLoading: isRejecting }] = useRejectPrepaymentsMutation();
  const [cancelAction, { isLoading: isCanceling }] = useCancelPrepaymentsMutation();
