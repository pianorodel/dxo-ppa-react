...
import { useApproveObligationsMutation, useCancelObligationsMutation, useRejectObligationsMutation, useReturnObligationsMutation } from "@/api/Endpoints/FMS/Transactions/Obligation/Obligations";
...
const ActionModal = ({
  ...
  // Calling Action API
  const [returnAction, { isLoading: isReturning }] = useReturnObligationsMutation();
  const [approveAction, { isLoading: isApproving }] = useApproveObligationsMutation();
  const [rejectAction, { isLoading: isRejecting }] = useRejectObligationsMutation();
  const [cancelAction, { isLoading: isCanceling }] = useCancelObligationsMutation();
