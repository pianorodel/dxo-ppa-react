...
import { useGetFAR3ReportQuery } from '@/api/Endpoints/FMS/Reports/FAR3Report';
...
const Far3 = ({ pdfTitle }) => {
    const { data, isFetching } = useGetFAR3ReportQuery({}, { refetchOnMountOrArgChange: true });
...
export default React.memo(Far3);