...
import { useGetFAR2ReportQuery } from '@/api/Endpoints/FMS/Reports/FAR2Report';
...
const Far2 = ({ pdfTitle }) => {
    const { data, isFetching } = useGetFAR2ReportQuery({}, { refetchOnMountOrArgChange: true });

    const columns = [
        { field: "particulars", header: "Particulars", width: "18%" },
        ...
        <PDFLandscape pdfTitle={pdfTitle}>
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>
                    As of 4th Quarter Ending March, 2025
                </Text>
            </View>
...
export default React.memo(Far2);