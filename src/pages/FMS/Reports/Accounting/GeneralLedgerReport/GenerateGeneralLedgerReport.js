...
const GenerateGeneralLedgerReport = ({ role = null, show, onCloseClick }) => {
  ...
  return (
    ...
    >
      <ModalHeader toggle={onCloseClick} className="p-3 bg-success-subtle">
        <div className="text-center w-100 pe-5">Generate General Ledger Report</div>
      </ModalHeader>

      <ModalBody>
        {state.toggle.isTogglePreviewReport &&
          <PDFPreviewModal
            modalTitle="General Ledger Report"
            show={true}
            DocumentComponent={GeneralLedgerReport}
...
export default GenerateGeneralLedgerReport;
