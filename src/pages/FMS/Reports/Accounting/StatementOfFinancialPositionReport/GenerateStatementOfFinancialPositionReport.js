...
import StatementPositionReport from "./StatementPositionReport";

const GenerateStatementOfFinancialPositionReport = ({ role = null, show, onCloseClick }) => {
    ...
    >
      ...
      <ModalBody>
        ...
        {state.toggle.isTogglePreviewReport &&
          <PDFPreviewModal
            modalTitle="Statement Of Financial Position Report"
            show={true}
            DocumentComponent={StatementPositionReport}
...
export default GenerateStatementOfFinancialPositionReport;
