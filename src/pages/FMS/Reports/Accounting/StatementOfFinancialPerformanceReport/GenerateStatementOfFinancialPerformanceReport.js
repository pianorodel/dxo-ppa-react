...
import StatementPerformanceReport from "./StatementPerformanceReport";

const GenerateStatementOfFinancialPerformanceReport = ({ role = null, show, onCloseClick }) => {
  ...
  return (
    ...
    >
      <ModalHeader toggle={onCloseClick} className="p-3 bg-success-subtle">
        <div className="text-center w-100 pe-5">Generate Statement Of Financial Position Report</div>
      </ModalHeader>
      ...
      <ModalBody>
        ...
        {state.toggle.isTogglePreviewReport &&
          <PDFPreviewModal
            modalTitle="Statement Of Financial Performance Report"
            show={true}
            DocumentComponent={StatementPerformanceReport}
...
export default GenerateStatementOfFinancialPerformanceReport;
