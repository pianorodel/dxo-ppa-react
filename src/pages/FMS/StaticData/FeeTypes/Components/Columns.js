...
export const getFeeTypesColumns = (handleAction) => {
    ...
    const desktopColumns = [
        {
            ...
            cell: ({ row }) => {
                return (
                    <LinkWithAvatarColumn onClick={() => handleAction('update', row.original)} name={row.original.feeTypeName} />
                );
            },
        },
        {
        ...
        },
        {
            ...
            cell: ({ row }) => {
                const item = row.original
                return (
                    <StaticDropDownActions accessRights={FMS_ACCESS_RIGHTS.FMS_STATICDATA_FEETYPES} handleActions={handleAction} data={item} />
                );
            },
        },
    ];
            ...
            cell: ({ row }) => {
                ...
                return (
                    <CardBody onClick={() => handleAction('update', item)}>
                        <LinkWithAvatarColumn name={item.feeTypeName} />
                    </CardBody>
                );
            },
        },
