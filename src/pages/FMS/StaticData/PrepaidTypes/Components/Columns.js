...
export const getPrepaidTypesColumns = (handleAction) => {
    ...
    const desktopColumns = [
        {
            ...
            cell: ({ row }) => {
                return (
                    <LinkWithAvatarColumn onClick={() => handleAction('update', row.original)} name={row.original.prepaidTypeName} />
                );
            },
        },
        {
        ...
        },
        {
            ...
            cell: ({ row }) => {
                const item = row.original
                return (
                    <StaticDropDownActions accessRights={FMS_ACCESS_RIGHTS.FMS_STATICDATA_PREPAIDTYPES} handleActions={handleAction} data={item} />
                );
            },
        },
    ];
            ...
            cell: ({ row }) => {
                ...
                return (
                    <CardBody onClick={() => handleAction('update', item)}>
                        <LinkWithAvatarColumn name={item.prepaidTypeName} />
                    </CardBody>
                );
            },
        },
