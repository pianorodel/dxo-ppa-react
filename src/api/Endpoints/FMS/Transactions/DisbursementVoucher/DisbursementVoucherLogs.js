...
const baseURL = process.env.REACT_APP_FMS_API + '/transactions/disbursementvouchers/logs';
const currentUser = getCurrentUser();

export const disbursementvoucherLogsAPI = createDynamicResourceAPI({
  resource: "DisbursementVoucherLogs",
  tagTypes: ["DisbursementVoucherLogs"],
      ...
      [`export${resource}`]: builder.mutation({
        ...
        async onQueryStarted(params, { queryFulfilled }) {
          try {
            ...
            link.href = url;
            link.download = `DisbursementVoucherLogs-${new Date().toISOString().split("T")[0]}.xlsx`;
...
export const {
  useGetDisbursementVoucherLogsQuery,
  useExportDisbursementVoucherLogsMutation
} = disbursementvoucherLogsAPI;
