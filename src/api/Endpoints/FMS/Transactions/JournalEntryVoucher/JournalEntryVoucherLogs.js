...
const baseURL = process.env.REACT_APP_FMS_API + '/transactions/journalentryvouchers/logs';
const currentUser = getCurrentUser();

export const journalentryvoucherLogsAPI = createDynamicResourceAPI({
  resource: "JournalEntryVoucherLogs",
  tagTypes: ["JournalEntryVoucherLogs"],
      ...
      [`export${resource}`]: builder.mutation({
        ...
        async onQueryStarted(params, { queryFulfilled }) {
          try {
            ...
            link.href = url;
            link.download = `JournalEntryVoucherLogs-${new Date().toISOString().split("T")[0]}.xlsx`;
