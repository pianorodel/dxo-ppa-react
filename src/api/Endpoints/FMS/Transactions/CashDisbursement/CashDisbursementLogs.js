...
const baseURL = process.env.REACT_APP_FMS_API + '/transactions/cashdisbursements/logs';
const currentUser = getCurrentUser();

export const cashdisbursementLogsAPI = createDynamicResourceAPI({
  resource: "CashDisbursementLogs",
  tagTypes: ["CashDisbursementLogs"],
      ...
      [`export${resource}`]: builder.mutation({
        ...
        async onQueryStarted(params, { queryFulfilled }) {
          try {
            ...
            link.href = url;
            link.download = `CashDisbursementLogs-${new Date().toISOString().split("T")[0]}.xlsx`;
...
export const {
  useGetCashDisbursementLogsQuery,
  useExportCashDisbursementLogsMutation
} = cashdisbursementLogsAPI;
