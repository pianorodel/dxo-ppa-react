...
const baseURL = process.env.REACT_APP_FMS_API + '/transactions/checkdisbursements/logs';
const currentUser = getCurrentUser();

export const checkdisbursementLogsAPI = createDynamicResourceAPI({
  resource: "CheckDisbursementLogs",
  tagTypes: ["CheckDisbursementLogs"],
      ...
      [`export${resource}`]: builder.mutation({
        ...
        async onQueryStarted(params, { queryFulfilled }) {
          try {
            ...
            link.href = url;
            link.download = `CheckDisbursementLogs-${new Date().toISOString().split("T")[0]}.xlsx`;
...
export const {
  useGetCheckDisbursementLogsQuery,
  useExportCheckDisbursementLogsMutation
} = checkdisbursementLogsAPI;
