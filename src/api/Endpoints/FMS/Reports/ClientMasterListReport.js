...
const baseURL = process.env.REACT_APP_FMS_API + '/reports/clientmasterlist';

export const clientMasterListReportAPI = createDynamicResourceAPI({
    resource: "ClientMasterListReport",
    tagTypes: ["ClientMasterListReport"],
...
export const {
    useGetClientMasterListReportQuery,
} = clientMasterListReportAPI;
